<div class="flex flex-no-wrap">
    <div class="w-2/12">
        ...
        <div class="sidebar fixed top-0 bottom-0 lg:left-0 p-2 w-[300px] overflow-y-auto text-center bg-gray-900">
            ...
            <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white" onclick="dropdownprof()">
            ...
            <hr class="my-2 border-b-1 border-gray-300 dark:border-gray-600"></hr>
            <x-navigation-item route="admin.settings" icon="bi bi-gear">
                Paymenter Settings
            </x-navigation-item>
            <div
            ...
            <div class="w-4/5 mx-auto" id="submenutickets">
                <x-navigation-item route="admin.tickets.create" icon="bi bi-plus-circle" dropdown="true">
                    Create Ticket
                </x-navigation-item>
                <x-navigation-item route="admin.tickets" icon="bi bi-ticket-detailed" dropdown="true">
                    View Ticket
                </x-navigation-item>
            </div>
            <x-navigation-item route="admin.products" icon="bi bi-box-seam">
                Products
            </x-navigation-item>
            <x-navigation-item route="admin.categories" icon="bi bi-bookshelf">
                Categories
            </x-navigation-item>
            <x-navigation-item route="admin.orders" icon="bi bi-receipt">
                Orders
            </x-navigation-item>

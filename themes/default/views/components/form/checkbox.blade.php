<div class="flex items-center {{ $divClass ?? '' }}">
    ...
    <input type="checkbox" name="{{ $name }}" id="{{ $id ?? $name }}"
        ...
        class="form-checkbox w-4 h-4 text-primary rounded focus:ring-secondary hover:bg-secondary ring-offset-primary-800 focus:ring-2 bg-gray-700 border-gray-600" />

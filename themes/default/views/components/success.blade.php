@if (session('success'))
    <div id="success" class="fixed bottom-0 left-1/2 transform -translate-x-1/2 z-50 flex items-center p-4 mb-16 text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 shadow-lg shadow-[#384b44]" role="alert">	

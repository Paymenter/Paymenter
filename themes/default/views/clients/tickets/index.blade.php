    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-xl sm:rounded-lg dark:bg-secondary-100">
                <div
                    class="p-6 bg-white border-gray-200 sm:pr-20 sm:pl-12 dark:bg-secondary-100 dark:text-darkmodetext pb-2">
                        ...
                        <div class="flex flex-row overflow-x-auto lg:flex-wrap lg:space-x-1">
                            <div class="flex-none">
                                <button
                                    ...
                                    {{ __('All Tickets') }}
                                    <span class="w-6 h-6 bg-red-600 rounded-full ml-1 mb-1 text-white"
            ...
            <div class="overflow-hidden bg-white shadow-xl sm:rounded-lg dark:bg-secondary-100 mt-6">
                <div
                    class="ticketBlockMaster overflow-hidden bg-white-200 shadow-xl sm:rounded-lg dark:bg-secondary-100 mt-6 pb-2.5">
                    @if (count($tickets) > 0)
                        ...
                        @foreach ($tickets as $ticket)
                            <div id="ticket-main"
                                class="ticketBlock mb-3 pt-3 bg-gray-100 dark:bg-darkbutton sm:rounded-lg ml-12 pb-3"
                                style="cursor: pointer"
                                onclick="window.location.href = '{{ route('clients.tickets.show', $ticket->id) }}'">
                                <div class="flex flex-row items-center justify-between ml-4">
                                    ...
                                    <div class="flex flex-row items-center justify-end mr-6">
                                        <div class="flex flex-row items-center justify-end space-x-2">
                                            ...
                                            <button class="dropbtn" type="button" aria-label="More options"
                                                aria-haspopup="true">
                                ...
                                <div class="flex flex-row items-center justify-between ml-4 pt-4">
                                    <div class="flex flex-row items-start justify-start">
                                        <div class="shrink-0 w-8 mt-1 mr-4">
                                            <img src="https://www.gravatar.com/avatar/{{ md5($user->email) }}?s=200&d=mp"
                                        ...
                                        <div class="flex flex-row items-center justify-end space-x-2">
                                            <div class="text-sm font-semibold flex">
                                                <div class="ml-1.5 text-black dark:text-darkmodetext">
                                                    <div
                                                        class="p-1 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">

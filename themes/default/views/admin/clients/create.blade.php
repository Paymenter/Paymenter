                                ...
                                <form method="POST" action="{{ route('admin.clients.store') }}">
                                    ...
                                    <div class="grid grid-cols-2 gap-4 mt-4">
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <input type="text" name="name" id="name" placeholder="John Doe" autocomplete="name" required
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <input type="text" name="email" id="email" placeholder="jdoe@example.com" autocomplete="email" required
                                                    class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm dark:bg-darkmode rounded-md">
                                            </div>
                                        </div>
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <input type="text" name="phone" placeholder="+1-234-567-89" id="phone" autocomplete="phone"
                                                    class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm dark:bg-darkmode rounded-md">
                                            </div>
                                        </div>
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <input type="text" placeholder="Optional" name="companynames" id="companynames" autocomplete="companynames"
                                                    class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm dark:bg-darkmode rounded-md">
                                            </div>
                                        </div>
                                        <div>
                                    ...
                                    <div class="grid grid-cols-3 gap-4">
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <input type="text" name="address" id="address" placeholder="Bobcat Lane" autocomplete="address"
                                                    class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm dark:bg-darkmode rounded-md">
                                            </div>
                                        </div>
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <input type="text" name="city" id="city" placeholder="St. Robert" autocomplete="city"
                                                    class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm dark:bg-darkmode rounded-md">
                                            </div>
                                        </div>
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <input type="text" name="state" id="state" placeholder="Missouri" autocomplete="state"
                                                    class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm dark:bg-darkmode rounded-md">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-2 gap-4 mt-4">
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <input type="text" name="zip" id="zip" placeholder="1234 NW" autocomplete="zip"
                                                    class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm dark:bg-darkmode rounded-md">
                                            </div>
                                        </div>
                                        <div>

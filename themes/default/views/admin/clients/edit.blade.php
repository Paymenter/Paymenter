                                ...
                                <form method="POST" action="{{ route('admin.clients.update', $user->id) }}">
                                    ...
                                    <div class="grid grid-cols-2 gap-4 mt-4">
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <input type="text" name="name" value="{{ $user->name }}" id="name" placeholder="John Doe" autocomplete="name" required
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <input type="text" name="email" id="email" value="{{ $user->email }}" placeholder="jdoe@example.com" autocomplete="email" required
                                                    class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm dark:bg-darkmode rounded-md">
                                            </div>
                                        </div>
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <input type="text" name="phone" value="{{ $user->phone }}" placeholder="+1-234-567-89" id="phone" autocomplete="phone"
                                                    class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm dark:bg-darkmode rounded-md">
                                            </div>
                                        </div>
                                        <div>
                                            <label for="companynames" class="dark:text-darkmodetext block text-sm font-medium text-gray-700">
                                                {{ __('Company Names') }}
                                            </label>
                                            <div class="mt-1">
                                                <input type="text" placeholder="Optional" value="{{ $user->companynames }}" name="companynames" id="companynames" autocomplete="companynames"
                                                    class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm dark:bg-darkmode rounded-md">
                                            </div>
                                        </div>
                                        <div>
                                            <label for="password" class="dark:text-darkmodetext block text-sm font-medium text-gray-700">
                                                {{ __('Password') }}
                                            </label>
                                            <div class="mt-1">
                                    ...
                                    <div class="grid grid-cols-3 gap-4">
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <input type="text" name="address" value="{{ $user->address }}" id="address" placeholder="Bobcat Lane" autocomplete="address"
                                                    class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm dark:bg-darkmode rounded-md">
                                            </div>
                                        </div>
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <input type="text" name="city" value="{{ $user->city }}" id="city" placeholder="St. Robert" autocomplete="city"
                                                    class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm dark:bg-darkmode rounded-md">
                                            </div>
                                        </div>
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <input type="text" name="state" value="{{ $user->state }}" id="state" placeholder="Missouri" autocomplete="state"
                                                    class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm dark:bg-darkmode rounded-md">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-2 gap-4 mt-4">
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <input type="text" name="zip" value="{{ $user->zip }}" id="zip" placeholder="1234 NW" autocomplete="zip"
                                                    class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm dark:bg-darkmode rounded-md">
                                            </div>
                                        </div>
                                        <div>
                                            <label for="country" class="dark:text-darkmodetext block text-sm font-medium text-gray-700">
                                                {{ __('Country') }}
                                            </label>
                                            <div class="mt-1">
                                                <input type="text" name="country" value="{{ $user->country }}" id="country" placeholder="United States" autocomplete="country"
                                                    class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm dark:bg-darkmode rounded-md">
                                            </div>
                                        </div>
                                    </div>

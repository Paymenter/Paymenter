<x-admin-layout>
    ...
    <div class="bg-white dark:bg-secondary-100 justify-between flex flex-row">
        <h1 class="text-2xl font-bold text-gray-500 dark:text-darkmodetext">{{ __('View Ticket #') }}{{ $ticket->id }}</h1>
        <button class="button button-primary text-sm" data-modal-target="{{ $ticket->id }}" data-modal-toggle="{{ $ticket->id }}">

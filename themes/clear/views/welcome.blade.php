<x-app-layout>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="container px-6 py-10 mx-auto mt-10">
            <div
                class="text-3xl font-semibold text-center text-gray-800 capitalize bg-gray-100 p-4 rounded-lg shadow-2xl lg:text-4xl dark:text-dark prose">

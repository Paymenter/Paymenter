...
return [
    ...
    'cancel_are_you_sure' => 'Êtes-vous certain de vouloir résilier ce service ?',
    ...
    'upgrade_choose_product' => 'Choisissez une offre vers laquelle mettre à niveau',
    ...
    'clear_billing_agreement' => 'Révoquer l\'autorisation de prélèvement',
    'select_billing_agreement' => 'Sélectionner l\'autorisation de prélèvement',

    'remove_payment_method' => 'Supprimer le mode de paiement',
    'remove_payment_method_confirm' => 'Êtes-vous certain de vouloir retirer le mode de paiement ":name" pour ce service ? Vous ne serez plus prélevé automatiquement pour ce service uniquement.',

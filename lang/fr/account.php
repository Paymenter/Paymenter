...
return [
    ...
    'two_factor_authentication_description' => 'Ajoutez un niveau de sécurité supplémentaire à votre compte en activant l\'authentification la double authentification.',
    ...
    'two_factor_authentication_enable_description' => 'Pour activer la double authentification, vous devez scanner le code QR ci-dessous avec une application d\'authentification comme Google Authenticator ou Authy.',

...
return [
    ...
    | classe de validação. Algumas dessas regras têm várias versões, como as regras de
    | tamanho. Sinta-se à vontade para ajustar cada uma dessas mensagens aqui.
    |
    */
    ...
    | especificar uma linha de linguagem personalizada específica para uma regra de atributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de linguagem são usadas para trocar nosso espaço reservado
    | de atributo por algo mais amigável, como "Endereço de E-Mail" em vez de

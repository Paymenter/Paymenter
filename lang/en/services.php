...
return [
    ...
    'plan' => 'Plan',
    'select_plan' => 'Select the plan',
    'quantity_label' => 'Quantity',
    'enter_quantity' => 'Enter the quantity',
    'expires_at' => 'Expires At',
    'select_expiration_date' => 'Select the expiration date',
    'coupon' => 'Coupon',
    'select_coupon' => 'Select the coupon',
    'price_col' => 'Price',
    'recalculate_price' => 'Recalculate Price',
    'price_recalculated_title' => 'The price has been successfully recalculated',
    'billing_agreement' => 'Billing Agreement',
    'select_billing_agreement_admin' => 'Select the billing agreement',
    'subscription_id' => 'Subscription ID (deprecated)',
    'enter_subscription_id' => 'Enter the subscription ID',
    'cancel_subscription' => 'Cancel Subscription',
    'subscription_cancelled_title' => 'The subscription has been successfully cancelled',
    'subscription_not_cancelled_title' => 'The subscription could not be cancelled',
    'id' => 'ID',
    'user' => 'User',

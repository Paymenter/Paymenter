        ...
        <div
            ...
            <div class="flex flex-row items-center">
                ...
                <button
                    ...
                    class="relative w-10 h-10 flex lg:hidden items-center justify-center rounded-lg hover:bg-primary/10 transition"
                        ...
                        <div class="mt-5">
                            ...
                            <div
                                ...
                                <button @click="userPanelOpen = true" aria-label="Open user menu" class="flex gap-4 items-center justify-start">
                                    <img src="{{ cyber_avatar(auth()->user()) }}" class="size-10 rounded-full border-2 border-primary/60 bg-background object-cover" alt="avatar" />
                                ...
                                <div
                                    ...
                                    <div class="bg-background-secondary shadow-lg rounded-t-2xl border border-neutral p-6">
                                        <div class="flex gap-4 items-center justify-start">
                                            <img src="{{ cyber_avatar(auth()->user()) }}" class="size-12 rounded-full border-2 border-primary/60 bg-background object-cover" alt="avatar" />

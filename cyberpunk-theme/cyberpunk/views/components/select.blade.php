...
>
    <button 
        ...
        class="relative w-full min-h-[38px] py-2 pl-3 pr-10 text-left cyber-card cyber-clip rounded-md shadow-sm cursor-pointer text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-800"
        type="button"
    >
    ...
    <ul
        ...
        class="absolute z-50 w-full py-1 overflow-auto cyber-card cyber-clip rounded-lg shadow-lg max-h-60 focus:outline-none text-sm"
        x-cloak
    >

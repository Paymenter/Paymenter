    ...
    <div class="px-2">
        ...
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-3 mt-8">
                <div class="cyber-card cyber-clip rounded-lg overflow-hidden size-9 flex items-center justify-center">
        ...
        <div class="cyber-card cyber-clip p-4 rounded-lg mb-4 hover:bg-background-secondary/80 transition-colors">
        ...
        @endforeach
        @else
        <div class="cyber-card cyber-clip p-6 rounded-lg text-center">
        ...
        <a href="{{ route('invoices.show', $transaction->invoice) }}" wire:navigate>
            <div
                class="cyber-card cyber-card-hover cyber-clip p-1 rounded-lg mb-4">
                <div class="flex items-center justify-between">

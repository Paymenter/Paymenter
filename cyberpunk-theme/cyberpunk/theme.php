...
return [
    ...
    'settings' => [
        ...
        */
        ...
        [
            'name' => 'general_reviews_name',
            'label' => 'Nombre de las reseñas del servicio',
            'type' => 'text',
            'default' => 'El servicio en general',
        ],
        [
            'name' => 'featured_reviews_enabled',
            'label' => 'Mostrar reseñas destacadas en el inicio',
            'type' => 'checkbox',
            'default' => true,
            'database_type' => 'boolean',
            'description' => 'Se ven después de los planes y justo antes de la comunidad.',
        ],
        [
            'name' => 'featured_reviews_title',
            'label' => 'Título de las reseñas destacadas',
            'type' => 'text',
            'default' => 'Lo que dicen nuestros clientes',
        ],
        [
            'name' => 'featured_reviews_subtitle',
            'label' => 'Subtítulo de las reseñas destacadas',
            'type' => 'text',
            'default' => 'Opiniones reales de gente que ya tiene sus servicios con nosotros.',
        ],
        [
            'name' => 'featured_reviews_limit',
            'label' => 'Cuántas reseñas destacadas mostrar',
            'type' => 'number',
            'default' => 3,
            'database_type' => 'integer',
            'min_value' => 1,

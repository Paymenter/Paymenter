...
class Virtualizor_EndUser_API
{
     ...
     */
    public function listvs($del_vpsid = 0, $search = [])
    {
    ...
    public function suspend_net($vpsid)
    {
    ...
    public function unsuspend_net($vpsid)
    {
    ...
    //since V3.1.3
    public function save_vertical_data($vid, $post)
    {
     ...
     * @return bool TRUE on success or FALSE on failure
     */
    public function editvm($vid, $post = [])
    {
     ...
     * @return bool TRUE on success or FALSE on failure
     */
    public function backup($vid, $post = [])
    {
    ...
    public function list_backup($vid)
    {
    ...
    public function restore_backup($post, $vid)
    {
    ...
    public function delete_backup($post, $vid)
    {
     ...
     * @return bool TRUE on success or FALSE on failure
     */
    public function rescue($vid, $pass)
    {
     ...
     * @return bool TRUE on success or FALSE on failure
     */
    public function disable_rescue($vid)
    {

        $post = ['disablerescue' => 1];
     ...
     * @return bool TRUE on success or FALSE on failure
     */
    public function monitor($vid = 0, $post = [])
    {
    ...
    public function system_alerts($vid)
    {
     ...
     */
    public function statuslogs($vid)
    {
    ...
    public function self_shutdown($vid, $post)
    {
    ...
    public function edituser($uid, $post = [])
    {
     ...
     */
    public function users($uid, $post = [])
    {
     ...
     */
    public function listrecipes($vid)
    {
    ...
    public function execrecipe($vid, $rid)
    {
     ...
     */
    public function processes($post, $vid)
    {
     ...
     */
    public function services($vid, $post = [])
    {
    ...
    public function hvmsettings($vid, $post = [])
    {
    ...
    public function managesubnets($vid)
    {
    ...
    public function pdns($post = [], $id = 0)
    {
    ...
    public function managezone($did, $post = [])
    {
    ...
    public function userpassword($post)
    {
    ...
    public function usersettings($post = [])
    {
     ...
     */
    public function addiso($vid, $isourl, $isoname)
    {
        $post = ['filename' => $isoname,
            'iso_url' => $isourl,
            'addiso' => '1',
        ];
     ...
     */
    public function deliso($vid, $isouuid)
    {
        $post = ['del' => $isouuid];
     ...
     */
    public function addsshkey($post = [])
    {
        $post['add'] = 1;
     ...
     */
    public function editsshkey($keyid, $post = [])
    {
        $post['edit'] = 1;
     ...
     * @return array
     */
    public function applysshkeys($vid, $post = [])
    {
        $post['addkeyvps'] = 1;
    ...
    public function webuzo_scripts($vid)
    {
     ...
     * @return array
     */
    public function installwebuzo($vid, $post = [])
    {
    ...
    public function listvolumes($search = [])
    {
    ...
    public function delete_volumes($post)
    {
    ...
    public function perform_action_volume($post)
    {
